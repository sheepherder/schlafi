...
Tiere: [
  ...
  'Hirsch','Gemse','Steinbock','Wisent','Elch','Rentier',
  ...
  'Leguan','Molch','Salamander','Frosch','Kröte',
  'Axolotl','Bartagame','Korallenfisch','Clownfisch','Kugelfisch',
  'Qualle','Tintenfisch','Krake','Nautilus','Seegurke',
  ...
  'Leuchtkäfer','Hirschkäfer','Nashornkäfer','Rosenkäfer',
  ...
  'Buckelwal','Orca','Schweinswal','Rochen','Mantarochen',
  'Meeresschildkröte','Suppenschildkröte','Karettschildkröte',
  'Panda','Känguru','Wombat','Schnabeltier','Opossum',
...
Landschaft: [
  ...
  'Tropfsteinhöhle','Eishöhle','Meereshöhle','Felsdom','Felsendom',
...
Wetter: [
  ...
  'Nebelschleier','Bodennebel','Hochnebel','Morgennebel','Abenddunst',
...
Gewässer: [
  ...
  'Meerenge','Sund','Wasserstraße','Fahrrinne',
  ...
  'Korallenriff','Saumriff','Barriereriff','Atoll',
...
Maritim: [
  ...
  'Fischernetz','Reuse','Steuerrad','Angel','Kescher','Fischkorb',
...
Gerichte: [
  ...
  'Falafel','Hummus','Shakshuka','Baba Ghanoush','Labneh',
...
Märchen: [
  ...
  'Burgtor','Zinne','Wendeltreppe','Burgmauer','Wappen',
  'Ritterhelm','Burgfräulein','Burgvogt','Knappe','Fanfare',
],
...
Reise: [
  ...
  'Seil','Karabiner','Klettergurt','Helm','Kopflampe',
  'Andenken','Souvenir','Ansichtskarte','Reisetagebuch','Fotoalbum',
  'Muschel','Kieselstein','Treibholz','Feder','Blütenblatt',
  'Postkarte','Briefmarke','Poststempel','Siegel','Wachssiegel',
  'Schatzkarte','Pergament','Rolle','Lupe','Astrolabium',
...
Berufe: [
  ...
  'Leuchtturmwärter','Förster','Parkwächter','Nachtwächter',
  ...
  'Astronom','Botaniker','Entdecker','Chronist',
],
...
Möbel: [
  ...
  'Kleiderschrank','Wäscheschrank','Schuhschrank','Apothekerschrank','Glasvitrine',
...
Sport: [
  ...
  'Frisbee','Boccia','Krocket','Ringwurf','Kubb',
...
Strand: [
  ...
  'Möwe','Strandläufer','Strandkrabbe','Wattwurm','Qualle',
...
Feste: [
  ...
  'Blumenstrauß','Blumenkranz','Blumengirlande','Tischgesteck','Blumenvase',
  'Einladungskarte','Platzkarte','Menükarte','Tischkarte','Dankkarte',
  'Fackel','Feuerwerk','Knallerbse','Tischfeuerwerk','Bengalfeuer',
  'Maibaum','Erntekrone','Erntedank','Laternenumzug','Martinsgans',
